...
const ParticleCard = ({ children, className = '', disableAnimations = false }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`${className} feature-card particle-container`}
      ...
      <div className="features-section">
        ...
        <div className="features-container">
          ...
          <div className="bento-grid" ref={gridRef}>
            {/* Card 1 */}
            <ParticleCard className="card1" disableAnimations={isMobile}>
              <div className="messages-gif-wrapper">
                <img src="/assets/messages.gif" alt="Messages animation" className="messages-gif" />
              </div>
              <h2>{isMobile ? '350' : <CountUp to={350} />}</h2>
              <h3>Produk Caktadent</h3>
              <p>Berhasil diproduksi & didistribusikan.</p>
            </ParticleCard>

            {/* Card 2 */}
            <ParticleCard className="card2" disableAnimations={isMobile}>
              ...
              <h3>Ibu-ibu PKK di Muara Enim</h3>
              <p>Aktif diberdayakan dalam produksi.</p>
            </ParticleCard>

            {/* Card 3 (baru) */}
            <ParticleCard className="card3" disableAnimations={isMobile}>
              <div className="chart-gif-wrapper">
              </div>
              <h3>Lolos uji keamanan BPOM</h3>
              <p>Menjamin kualitas & keamanan produk.</p>
            </ParticleCard>

            {/* Card 4 */}
            <ParticleCard className="card4" disableAnimations={isMobile}>
              <div className="switch-gif-wrapper">
                <img src="/assets/switch.gif" alt="Switch animation" className="switch-gif" />
              </div>
              <h2>{isMobile ? '15' : <CountUp to={15} />}+</h2>
              <h3>Pelajar & pemuda lokal</h3>
              <p>Terlibat dalam riset & pengembangan paten.</p>
            </ParticleCard>
          </div>
        </div>
      </div>
